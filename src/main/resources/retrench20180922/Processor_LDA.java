/*
Project 1 - Processing element for LDA
...
public class Processor_LDA {
  //CONSTANTS
  // debug constants
  private static final int MODULE_DEBUG_FLAG = 1;

  public static int executeLDA(int[] instruction_fields, int remaining_ticks, Processor processor) {
    int branch_id = -1;
        ...
        if (remaining_ticks_return > 0) {
          ...
          try {
            ...
            if (MODULE_DEBUG_FLAG == 1) {
              System.out.println("LDA had problem accessing R[" + instruction_fields[1] + "].");
      ...
      case 1:
        ...
        if (remaining_ticks_return > 2) {
          ...
          try {
            ...
            if (MODULE_DEBUG_FLAG == 1) {
              System.out.println("LDA had problem accessing X[" + instruction_fields[2] + "].");
              bound_error.printStackTrace();
            }
          } finally {
            remaining_ticks_return--;
